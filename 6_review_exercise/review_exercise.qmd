...
**Step 1.** Common denominator — align both fractions to $\sin\theta\cos\theta$:

$$\frac{\sin 3\theta\cos\theta - \cos 3\theta\sin\theta}{\sin\theta\cos\theta}$$

**Step 2.** The numerator is the sine difference formula $\sin(A-B) = \sin A\cos B - \cos A\sin B$ in reverse:

$$= \frac{\sin(3\theta - \theta)}{\sin\theta\cos\theta} = \frac{\sin 2\theta}{\sin\theta\cos\theta}$$

**Step 3.** Convert the denominator using the double angle formula $\sin 2\theta = 2\sin\theta\cos\theta$:
...
**Step 1.** Expand using definitions — $\csc\theta = \dfrac{1}{\sin\theta}$, $\cot 2\theta = \dfrac{\cos 2\theta}{\sin 2\theta}$:

$$\frac{1}{\sin\theta} - \frac{2\cos 2\theta\cos\theta}{\sin 2\theta}$$

**Step 2.** Substitute $\sin 2\theta = 2\sin\theta\cos\theta$ and combine fractions:
...
**Step 3.** Apply $1 - \cos 2\theta = 2\sin^2\theta$:
...
**Step 1.** Rewrite using $\sec\theta = \dfrac{1}{\cos\theta}$ and simplify:

$$\frac{1/\cos\theta - 1}{1/\cos\theta + 1} = \frac{1 - \cos\theta}{1 + \cos\theta}$$

**Step 2.** Apply the half-angle identities — $1-\cos\theta = 2\sin^2\!\tfrac{\theta}{2}$, $1+\cos\theta = 2\cos^2\!\tfrac{\theta}{2}$:

$$= \frac{2\sin^2(\theta/2)}{2\cos^2(\theta/2)} = \tan^2\frac{\theta}{2} \quad \blacksquare$$

::: {style="font-size: 0.85em; color: #666;"}
**Half-angle identity derivation:** From $\cos 2\alpha = 1 - 2\sin^2\alpha$, set $\alpha = \theta/2$ to get $1 - \cos\theta = 2\sin^2(\theta/2)$.  Similarly from $\cos 2\alpha = 2\cos^2\alpha - 1$, $1 + \cos\theta = 2\cos^2(\theta/2)$.
:::
...
**Step 1.** Apply the tan difference formula to $\tan\!\left(\dfrac{\pi}{4} - x\right)$ — using $\tan\!\left(\dfrac{\pi}{4}\right) = 1$:

$$= \frac{1 - \tan x}{1 + \tan x}$$

**Step 2.** Substitute $\tan x = \dfrac{\sin x}{\cos x}$ and multiply numerator and denominator by $\cos x$:

$$= \frac{\cos x - \sin x}{\cos x + \sin x}$$

**Step 3.** Multiply numerator and denominator by $(\cos x - \sin x)$ to create a squared numerator:

$$= \frac{(\cos x - \sin x)^2}{\cos^2 x - \sin^2 x} = \frac{\cos^2 x - 2\sin x\cos x + \sin^2 x}{\cos^2 x - \sin^2 x}$$

**Step 4.** Apply $\cos^2 x + \sin^2 x = 1$, $2\sin x\cos x = \sin 2x$, $\cos^2 x - \sin^2 x = \cos 2x$:
